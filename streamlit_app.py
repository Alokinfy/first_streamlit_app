...
try:
  ...
  streamlit.error("Doesn't sound like a fruit !!")
...
your_choice = streamlit.text_input('What fruit would you like to add?')
streamlit.write('Thanks for adding ', your_choice)
